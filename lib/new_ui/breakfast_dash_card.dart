...
class BreakfastDashCard extends StatefulWidget {
  String title;
  double totalCalories;
  List<String> breakfastItems;

  BreakfastDashCard({this.title, this.breakfastItems, this.totalCalories});

  @override
  _BreakfastDashCardState createState() => _BreakfastDashCardState();
}

class _BreakfastDashCardState extends State<BreakfastDashCard> {
  int a = 1;
  @override
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ListView.builder(
                              ...
                              itemCount: widget.breakfastItems.length,
                              itemBuilder: (context, index) {
                                return Text(
                                  '${widget.breakfastItems[index]}',
                                  style: TextStyle(
                                    fontFamily: FitnessAppTheme.fontName,
