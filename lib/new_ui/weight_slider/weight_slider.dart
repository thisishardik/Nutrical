...
import 'package:nutrical/new_ui/weight_slider/weight_slider_ball.dart';
import 'package:provider/provider.dart';
// import 'package:test_app/humidity_slider/weight_slider_ball.dart';

import 'weight_humidity.dart';
import 'weight_humidity_congfig.dart';
import 'weight_humidity_cureved_line.dart';
import 'weight_measurement_numbers.dart';
import 'weight_theme.dart';
...
class _SliderHandleState extends State<SliderHandle> {
  ...
  void initState() {
    ...
    config = context.read<HumidityConfigW>();
