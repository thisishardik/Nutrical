...
import 'package:nutrical/new_ui/weight_slider/weight_theme.dart';
import 'package:provider/provider.dart';
// import 'package:test_app/humidity_slider/weight_humidity_info.dart';
    ...
    return AnimatedBuilder(
        ...
        builder: (_, __) {
          ...
          if (controller.isAnimating &&
            ...
            if (widget.isActive) {
              text = ' ${widget.activeValue.round()}kg';
              var dy = (widget.notActiveNumber - widget.activeValue) *
                  widget.oneUnit;
              offset = Offset(0, dy);
            } else {
              text = ' ${widget.notActiveNumber}kg';
              offset = Offset.zero;
            }
          }
